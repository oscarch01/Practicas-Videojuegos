...
class client_view(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def start_connection(self):
        ...
        # Se recuperan valores de controles
        ...
        # Se deshabilitan controles por seguridad
        ...
        # Se imprimen datos de conexión
        print('server ip: {}\nserver port: {}\nclient ip: {}\nclient port: {}',server_ip, server_port, client_ip, client_port)
        # Se realizar conexión
        self.cn = Cliente(800,600,server_ip,int(server_port),"Cliente")
        self.cn.main()
