...
import game_view.GameFrame;
import game_view.GamePanel;
import game_view.MarioPanel;
...
public class client_view extends javax.swing.JFrame implements Observer {
    ...
    public String[] splitRead(String read){
        ...
        switch(arr[0]){
            //  Conectar cliente  
            case "CONF":
                System.out.println("iniciando juego con conf"+arr[1]+","+arr[2]);
                GamePanel gp = new GamePanel(Integer.valueOf(arr[1]));
                MarioPanel mp = new MarioPanel(Integer.valueOf(arr[2]));
                GameFrame gf = new GameFrame(mp,client);
