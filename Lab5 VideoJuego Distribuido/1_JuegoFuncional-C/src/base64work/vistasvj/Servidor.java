...
public class Servidor extends javax.swing.JPanel {
    ...
    public Servidor(server_game server, MiVentana mv) {
        initComponents();
    ...
    private void start_gameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_start_gameActionPerformed
        // TODO add your handling code here:
        String str = "CONF:"+this.panelBG.getBackgroud()+":"+this.panelPY.getAvatar();
        this.server.broadcast(str);
        this.mv.dispatchEvent(new WindowEvent(mv, WindowEvent.WINDOW_CLOSING));
