...
import base64work.vistasvj.VideoJuego;
import java.net.InetAddress;
import java.net.UnknownHostException;
import javax.swing.JFrame;
import base64work.vistasvj.Principal;
import base64work.vistasvj.Cliente;
...
public class MiVentana extends JFrame{
    ...
    public void setServerView(server_game srv) {
        // Remueve todos los componentes
        this.getContentPane().removeAll();
        // Crear panel servidor si no existe
        if (this.jpServidor == null) {
            this.jpServidor = new Servidor(srv,this);
        }
        // Agregar panel a la ventana y exponerlo
